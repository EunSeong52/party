...
// 텍스트의 사라지는 방향 애니
gsap.to("[data-direct]",{ //속성중에 data-direct이 있는 것들 모두 다 호출됨.
  x:(i,el)=> (el.getAttribute("data-direct")) * 400 ,  //el은 data-direct 속성을 가지고있는 요소들을 하나씩 받아옴 // i 인덱스 번호
  ease:"none",
  scrollTrigger:{
    trigger:".text_wrap",
    start:"top 20%",
...
gsap.to("[data-speed]",{
  ...
  ease:"none",
  scrollTrigger:{
    start:0,     // 스크롤트리거가 시작되는 스크롤 위치
    end:"max",    // 스크롤트리거가 끝나는 스크롤 위치
    scrub:2,
